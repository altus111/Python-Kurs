...
def func6a(a, *values,**keyValues):
    values1 = list(values)
    values1[2] = 9999
    for eintrag in keyValues:
        if eintrag == 'e':
            keyValues[eintrag] = 900
    return a,values1,values,keyValues

test = func6a('Peter', 1, 2, 3, 4, 5, pi=3.1415, e=2.78)
